...
fn main() {
    ...
    let mateiral_left = Rc::new(Metal::new(Color::new(0.8, 0.8, 0.8)));
    let mateiral_right = Rc::new(Metal::new(Color::new(0.8, 0.6, 0.2)));
    let world = vec![
    ...
    imgbuf.save("images/shiny_metal.png").unwrap();
}
