...
fn main() {
    ...
    let mateiral_center = Rc::new(Lambertian::new(Color::new(0.7, 0.3, 0.3)));
    let mateiral_left = Rc::new(Metal::with_fuzzy(Color::new(0.8, 0.8, 0.8), 0.3));
    let mateiral_right = Rc::new(Metal::with_fuzzy(Color::new(0.8, 0.6, 0.2), 1.0));
    let world = vec![
    ...
    imgbuf.save("images/fuzzed_metal.png").unwrap();
}
